...
DEFINES		=
EXTRA_CFLAGS	= 
CPPFLAGS	= -I. -I$(srcdir) $(DEFINES) -DHAVE_CONFIG_H -DYYPATCH=`cat $(srcdir)/VERSION` -D_GNU_SOURCE
CFLAGS		= -g -O2 $(CPPFLAGS) $(EXTRA_CFLAGS)
...
prefix		= /gpfs/data/fs71391/malexand/opt
exec_prefix	= ${prefix}
...
################################################################################
#docs docs-yacc :: yacc.txt
docs docs-yacc :: yacc.html
docs docs-yacc :: yacc.pdf
docs docs-yacc :: yacc.ps
docs docs-yacc :: yacc.txt
